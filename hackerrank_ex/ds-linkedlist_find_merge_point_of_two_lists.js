...
function findMergeNode(headA, headB) {
    // if either list reaches null, point it to the head of the other list
    // this naturally aligns the pointers after some iterations
    let currentA = headA
    let currentB = headB
    
    while (currentA !== currentB) {
        // when we reach the end of A, go to head of B
        currentA = currentA === null ? headB : currentA.next
        // when we reach the end of B, go to head of A
